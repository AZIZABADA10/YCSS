        ...
        <div class="relative rounded-2xl px-6 py-10 sm:px-10 sm:py-12
            ...
            <h2 class="fade-2 font-rajdhani text-center text-xl sm:text-2xl font-bold
                ...
                <span class="bg-gradient-to-r from-blue-400 to-cyan-400
                             bg-clip-text text-transparent">Account</span>
            </h2>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                {{-- Terms & Privacy (Jetstream) --}}
                @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                    <div class="fade-7 mt-4">
                        <label for="terms" class="flex items-start gap-3 cursor-pointer">
                            <x-checkbox name="terms" id="terms" required
                                        class="mt-0.5 shrink-0" />
                            <span class="text-sm text-blue-200/70 leading-snug">
                ...
                <div class="fade-7 mt-7 flex flex-col items-stretch gap-3
                    ...
                    <button type="submit"
                            class="btn-register font-rajdhani rounded-xl px-8 py-3
                ...
                {{-- Divider --}}
                <div class="fade-8 my-6 border-t border-blue-500/15"></div>

                {{-- Login link --}}
                <p class="fade-8 text-center text-sm text-blue-200/60">
